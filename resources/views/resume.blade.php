  ...
  <body class="text-gray-800 bg-gray-50">
    ...
    <x-layout :title="$resume->basics->name . ' Résumé'">
      <x-slot:header>
        ...
        <div
          class="relative w-full bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden"
        >
          <!-- Content container -->
          <div class="relative z-10 max-w-5xl mx-auto px-6 py-20">
            ...
            >
              ...
              <div class="flex-1">
                ...
                <h1
                  class="text-5xl md:text-6xl lg:text-7xl font-black bg-gradient-to-r from-white via-blue-100 to-indigo-200 bg-clip-text text-transparent mb-4 leading-tight"
                >
                  {{ $resume->basics->name }}
                </h1>
                ...
                <div class="flex items-center gap-3 mb-8">
                  <div
                    class="w-12 h-0.5 bg-gradient-to-r from-blue-400 to-indigo-400"
                  ></div>
                  <h2 class="text-xl md:text-2xl font-semibold text-blue-100">
                    {{ $resume->basics->label }}
                  </h2>
                  <div
                    class="w-12 h-0.5 bg-gradient-to-r from-indigo-400 to-blue-400"
                  ></div>
                </div>
                ...
                <div class="flex flex-wrap gap-6 text-slate-200 mb-8">
                  ...
                  @endif @if($resume->basics->location->city &&
                ...
                <div class="flex flex-wrap gap-3">
                  ...
                  >
                    <span
                      class="group-hover:text-blue-100 transition-colors duration-200"
      ...
      <div class="pt-16 grid gap-y-16">
              ...
              >
                <div class="flex-1">
                  ...
                  <div class="flex items-center gap-2 mb-3">
                    <div
                      class="w-2 h-2 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full"
                    ></div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <x-section-card>
              <div class="flex justify-between items-start mb-4">
                ...
                @if($skill->level)
                <span
                  class="px-3 py-1  text-white text-sm font-medium rounded-full shadow-sm"
                  {{-- {{ $skill->level->color() }} --}}
                >
                  {{-- {{ $skill->level->title() }} --}}
                </span>
        ...
        <section>
          ...
          <div class="space-y-6">
            ...
            <x-section-card>
              <div
                class="flex flex-col lg:flex-row lg:justify-between lg:items-start mb-4"
              >
                <div class="flex-1">
                  <h3 class="text-2xl font-bold text-slate-800 mb-2">
                    {{ $project->name }}
